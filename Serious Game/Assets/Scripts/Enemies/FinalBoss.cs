...
public class FinalBoss : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        //_enemySpeed = _boss.GetComponent<NavMeshAgent>().Speed;
    ...
    {
        //Debug.Log(nclue);
        if (other.gameObject == _boss)
        {
            count = 0;
            _enemySpeed = _agent.speed;
            _boss.GetComponent<MiniBoss>()._target = _boss.GetComponent<Transform>();
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        if (other.gameObject == _boss)
        {
            other.GetComponent<NavMeshAgent>().speed = _enemySpeed;
        }
